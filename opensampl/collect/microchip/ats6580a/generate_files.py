...
from opensampl.collect.microchip.ats6580a.context import ModemContextReader
...
def collect_files(
    ...
    while True:
        ...
        try:
            ...
            context_reader = ModemContextReader(host=host, port=control_port, prompt=prompt)
            ...
            output_file = output_path / f"{host}_6580a_{timestamp_str}.csv"
...
def main(
    ip_address: str, control_port: int, status_port: int, prompt: str, dump_interval: int, total_duration: int, output_dir: str
):
    """
