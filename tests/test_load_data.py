...
class TestWriteToTable:
    ...
    def test_write_to_table(self, mock_config, mock_session, sample_table_data,
                            test_db, mock_table_factory_with_mockdb):
        """Test write_to_table with actual database writes."""
        # Get the real table class for locations
        Locations = test_db.table_mappings["Locations"]
    ...
    def test_conflict_handling(self, mock_config, mock_session, sample_table_data, test_db, mock_table_factory_with_mockdb):
    ...
    def test_backend_routing(self, mock_config_class, mock_request, sample_table_data):
    ...
    def test_validation(self, mock_config, mock_session, sample_table_data):
    ...
    def test_session_validation(self, mock_config, sample_table_data):
...
#
#     def test_real_database_write(self, mock_config, mock_session, test_db,
#                                                sample_probe_key, sample_metric_type,
#                                                sample_reference_type, sample_time_data):
...
class TestLoadProbeMetadata:
    ...
    def test_real_session_flow(self, mock_config, mock_session,
                                                   sample_probe_key, sample_adva_metadata, test_db, mock_table_factory_with_mockdb):
        ...
        ProbeMetadata = test_db.table_mappings.get('ProbeMetadata')
...
class TestMockDb:
    ...
    def test_real_database_models_accessible(self, test_db):
        ...
        ProbeMetadata = test_db.table_mappings["ProbeMetadata"]
    ...
    def test_real_session_operations(self, mock_session, test_db):
