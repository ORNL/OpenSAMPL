...
def test_adva_vendor(mock_vendor_data):
    ...
    adva_vendor = adva.AdvaVendor(mock_vendor_data["name"], mock_vendor_data["config"], mock_vendor_data["credentials"])
...
def test_vendor_connection(mock_vendor_data, mock_api_client):
    ...
    vendor = adva.AdvaVendor(mock_vendor_data["name"], mock_vendor_data["config"], mock_vendor_data["credentials"])
...
def test_vendor_invalid_credentials(mock_vendor_data, invalid_credentials):
    ...
    with pytest.raises(ValueError):
        adva.AdvaVendor(mock_vendor_data["name"], mock_vendor_data["config"], invalid_credentials)
